...
public class UserIndexController {
    ...
    public void createAppointment(ActionEvent actionEvent) throws IOException {
        ...
        appRouter.pushToRoute("/CreateAppointmentView.fxml", "/UserIndexView.fxml");

    }

    @FXML
    public void goToEditMyAccountView() throws IOException {
        appRouter.pushToRoute("/EditMyAccountView.fxml", "/UserIndexView.fxml");
    }
    ...
    private void initInviteSSE() {
        ...
        new Thread() {
            @Override
            public void run() {
                System.out.println(notificationService.isNewInvitations() + "############################");
                for (; ; ) {
    ...
    public void goToInvitations() throws IOException {
        invitationsBtn.setStyle("-fx-border-color: black;");
        appRouter.pushToRoute("/InvitationsView.fxml", "/UserIndexView.fxml");
    }
